...
public class Trigonometry {
     ...
     * depending on a function and return value
     *
     * @param func   - name function
     * @param number - value, number
     * @return - result
     */
    public static double getOperation(String func, double number) {
        double result;
    ...
    /**
     * A method that tests whether characters
     * in an expression are trigonometric
     * expressions or logorithms
     *
     * @param chars - Array of characters parsed from the input expression
     * @param i     - counter
     * @return - true of false
     */
    public static boolean isFunction(char[] chars, int i) {
