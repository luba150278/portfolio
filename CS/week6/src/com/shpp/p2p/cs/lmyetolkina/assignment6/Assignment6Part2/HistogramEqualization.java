...
public class HistogramEqualization extends WindowProgram implements ComponentListener {
    ...
    private void computeEqualizedImage() {
        ...
        int[][] pixels = com.shpp.p2p.cs.lmyetolkina.assignment6.Assignment6Part2.HistogramEqualizationImageTransforms.toGrayscale(this.displayImage).getPixelArray();
        int[][] intensities = com.shpp.p2p.cs.lmyetolkina.assignment6.Assignment6Part2.HistogramEqualizationImageTransforms.imageToLuminances(pixels);
        int[][] result = com.shpp.p2p.cs.lmyetolkina.assignment6.Assignment6Part2.HistogramEqualizationLogic.equalize(intensities);
