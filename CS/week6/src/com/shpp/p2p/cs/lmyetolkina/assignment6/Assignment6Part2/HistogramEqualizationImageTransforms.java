...
public class HistogramEqualizationImageTransforms {
    ...
    public static class HistogramEqualization extends WindowProgram implements ComponentListener {
        ...
        private void computeEqualizedImage() {
            ...
            int[][] pixels = toGrayscale(this.displayImage).getPixelArray();
            int[][] intensities = imageToLuminances(pixels);
