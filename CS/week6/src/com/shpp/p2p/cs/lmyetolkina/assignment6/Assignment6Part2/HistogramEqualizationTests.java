...
public class HistogramEqualizationTests extends SimpleProgram {
    public void init() {
        com.shpp.p2p.cs.lmyetolkina.assignment6.Assignment6Part2.teest.TeestRunnerPanel panel = new com.shpp.p2p.cs.lmyetolkina.assignment6.Assignment6Part2.teest.TeestRunnerPanel(new com.shpp.p2p.cs.lmyetolkina.assignment6.Assignment6Part2.teest.TeestSuite[]{new com.shpp.p2p.cs.lmyetolkina.assignment6.Assignment6Part2.teest.TeestSuite("histogramFor Tests", new com.shpp.p2p.cs.lmyetolkina.assignment6.Assignment6Part2.teest.TeestCase[]{new com.shpp.p2p.cs.lmyetolkina.assignment6.Assignment6Part2.teest.TeestCase() {
        ...
        }, new com.shpp.p2p.cs.lmyetolkina.assignment6.Assignment6Part2.teest.TeestCase() {
            public String getName() {
        ...
        }}), new com.shpp.p2p.cs.lmyetolkina.assignment6.Assignment6Part2.teest.TeestSuite("cumulativeSumFor Tests", new com.shpp.p2p.cs.lmyetolkina.assignment6.Assignment6Part2.teest.TeestCase[]{new com.shpp.p2p.cs.lmyetolkina.assignment6.Assignment6Part2.teest.TeestCase() {
            public String getName() {
                return "Result array should have proper number of entries.";
            }
        ...
        }}), new com.shpp.p2p.cs.lmyetolkina.assignment6.Assignment6Part2.teest.TeestSuite("totalPixelsIn Tests", new com.shpp.p2p.cs.lmyetolkina.assignment6.Assignment6Part2.teest.TeestCase[]{new com.shpp.p2p.cs.lmyetolkina.assignment6.Assignment6Part2.teest.TeestCase() {
            public String getName() {
