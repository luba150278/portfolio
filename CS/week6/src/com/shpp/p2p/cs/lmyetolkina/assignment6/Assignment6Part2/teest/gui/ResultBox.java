package com.shpp.p2p.cs.lmyetolkina.assignment6.Assignment6Part2.teest.gui;
...
public class ResultBox extends GCanvas implements MouseListener, ComponentListener {
    ...
    private volatile com.shpp.p2p.cs.lmyetolkina.assignment6.Assignment6Part2.teest.TeestResult result;
    ...
    private static Map buildResultToDisplayMap() {
        ...
        result.put(com.shpp.p2p.cs.lmyetolkina.assignment6.Assignment6Part2.teest.ResultTypeHolder.ResultType.SUCCESS, new ResultBox.ResultInfo(Color.GREEN, "Pass"));
        result.put(com.shpp.p2p.cs.lmyetolkina.assignment6.Assignment6Part2.teest.ResultTypeHolder.ResultType.FAILURE, new ResultBox.ResultInfo(new Color(255, 127, 0), "Fail"));
        result.put(com.shpp.p2p.cs.lmyetolkina.assignment6.Assignment6Part2.teest.ResultTypeHolder.ResultType.EXCEPTION, new ResultBox.ResultInfo(Color.RED, "Error!"));
        return result;
    }
    ...
    public void setResult(com.shpp.p2p.cs.lmyetolkina.assignment6.Assignment6Part2.teest.TeestResult result) {
        this.result = result;
